...
public class ItemTouchHelperExtension extends RecyclerView.ItemDecoration
    ...
    /**
     * Close opened item if exists or do nothing
     */
        ...
        if (mSelected != null) {
            ...
            if (prevSelected.itemView.getParent() != null) {
                ...
                switch (swipeDir) {
                    ...
                    case END:
                        targetTranslateY = 0;
                        float swipeWidth = mCallback.getSwipeWidth(mSelected, swipeDir);
...
//            return false;
    ...
    public abstract static class Callback {
        ...
        public float getSwipeWidth(ViewHolder holder, int swipeDirection) {
            return -1;
        }
    }
